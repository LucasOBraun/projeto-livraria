...
$con = $conn->query($consulta) or die("Não foi possivel listar os livros.");
...
<table style="background-color: rgba(255,185,0,0.89)" class="table table-bordered" align="center">
        <tr class="table">
            ...
            <th scope="col"><b>Publicadora </b></th>
            <th scope="col"><b>Código (ISBN) </b></th>
            <th scope="col"><b>Nº de Páginas </b></th>
    ...
    <?php while ($dados = $con->fetch_array()){ ?>
        <tr class="table">
            ...
            <td><?php echo $dados["autor_id"]; ?></td>
            <td><?php echo $dados["publicadora_id"]; ?></td>
            <td><?php echo $dados["isbn"]; ?></td>
            <td><?php echo $dados["numero_pg"]; ?></td>
            <td><a type="submit" href="edita_livro.php?id=<?php echo $dados["id"]; ?>">Editar </a>
                <a type="submit" href="processa_deleta_livro.php?id=<?php echo $dados["id"]; ?>">Deletar </a></td>
        </tr>
    <?php } ?>
