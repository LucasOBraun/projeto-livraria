...
$consulta = "SELECT * FROM Publicadoras";
$con = $conn->query($consulta) or die("Não foi possivel listar as Publicadoras.");
?>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width-device-width, initial-scale=1.0">
    <title>Publicadoras Cadastradas</title>
...
<br><br>
<h1 align="center">Lista de Publicadoras</h1>
<br>
<div class="container">
<table style="background-color: rgba(255,185,0,0.89)" class="table table-bordered" align="center">
    ...
    <?php while ($dados = $con->fetch_array()){ ?>
        <tr class="table">
            ...
            <td><a type="submit" href="edita_publicadora.php?id=<?php echo $dados["id"]; ?>">Editar </a>
                <a type="submit" href="processa_deleta_publicadora.php?id=<?php echo $dados["id"]; ?>">Deletar </a></td>
        </tr>
    <?php } ?>
