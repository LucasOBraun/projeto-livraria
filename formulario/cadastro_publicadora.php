...
<html lang="pt-br">
    <head>
        ...
        <title>Cadastrar Publicadora</title>
        ...
        <nav class="navbar navbar-fixed-top navbar-expand-lg navbar-light bg-warning">
            ...
            <br><h1 align="center">Cadastrar Publicadora</h1>

            <form align="center" method="post" action="processa_publicadora.php">
                <br><label><b>Nome: </b></label>
                <input type="text" name="nome" placeholder="Digite o nome da publicadora "><br><br>
