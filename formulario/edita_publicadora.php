...
$id = $_GET['id'];
$result_edit_publicadora = "SELECT * FROM Publicadoras WHERE id='{$id}'";
$resultado_edit_publicadora = $conn->query($result_edit_publicadora) or die ("Não foi possível listar o autor");
$row_publicadora = mysqli_fetch_assoc($resultado_edit_publicadora);
?>
<!DOCTYPE html>
<html lang="pt-br">
    <head>
        ...
        <nav class="navbar navbar-fixed-top navbar-expand-lg navbar-light bg-warning">
            ...
            <br><h1 align="center">Editar Publicadora</h1>

            <form align="center" method="post" action="processa_edita_publicadora.php">
                <br><br><label><b>Antigo: </b></label>
                <input type="hidden" name="id" value="<?php echo $row_publicadora['id']; ?>">
                <input type="text" disabled="disabled"  name="<?php echo $row_publicadora['id']; ?>" value="<?php echo $row_publicadora['nome']; ?>">
                <br><br>
                <label><b>Novo: </b></label>
                <input formmethod="get" type="text" name="nome" placeholder="Digite a publicadora">
                <br><br>
